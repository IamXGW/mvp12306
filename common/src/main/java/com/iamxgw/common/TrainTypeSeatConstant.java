...
public class TrainTypeSeatConstant {
    ...
    // 特殊的<车厢 carriage、排 row、座位 seat>，默认为 5，不等于 5 时才放进来
    ...
    static {
        ...
        seatCarriageLevelTable.put(TrainType.CRH2, 2, TrainSeatLevel.GRAND_1);

        seatCarriageLevelTable.put(TrainType.CRH5, crh5CarriageRowTotal.size() - 1, TrainSeatLevel.TOP_GRADE);
        seatCarriageLevelTable.put(TrainType.CRH5, crh5CarriageRowTotal.size() - 2, TrainSeatLevel.GRAND_1);
